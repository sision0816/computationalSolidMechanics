...
buildSimplicialQuadrature<2, 3>() {
  ...
  array<double, 3> weights = {{oneThird,
                               oneThird,
                               oneThird}};
...
buildSimplicialQuadrature<3, 1>() {
  ...
  array<double, 1> weights = {{1.0e0/6.}};
...
buildSimplicialQuadrature<3, 4>() {
  ...
  points[4] = Matrix<double, 3, 1>(0.1381966011250150e0,
                                   0.1381966011250150e0,
                                   0.1381966011250150e0);
  array<double, 4> weights = {{0.25e0/6., 0.25e0/6., 0.25e0/6., 0.25e0/6.}};
...
buildSimplicialQuadrature<3, 5>() {
  ...
  array<double, 5> weights = {{-0.8e0/6., 0.45e0/6., 0.45e0/6., 0.45e0/6., 0.45e0/6.}};
